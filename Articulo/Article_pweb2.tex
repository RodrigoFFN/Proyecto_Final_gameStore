...
\author{\IEEEauthorblockN{1\textsuperscript{st} Flores Nuñes, Rodrigo Fransisco}
\IEEEauthorblockA{\textit{Univercidad Nacioal De San Agustin)} \\
\textit{}
Arequipa, Peru \\
...
\caption{Example of a figure caption.}7
\label{fig}
\end{figure}
